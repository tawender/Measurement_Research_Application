...
class App:
    ...
    def create_fixture_select_section(self):
        ...
        fixture_selection_frame = LabelFrame(self.root,text="Test Fixture Selection",padx=10,pady=10)
    ...
    def create_mfc_control_section(self):
        #create MFC control section
        mfc_control_frame = LabelFrame(self.root,text="MFC Control")
